...
<div class="em-menu-general em-menu-group">
	...
	<div class="inside">
			...
			<?php
				...
				em_options_textarea ( __( 'Success Message (Danish)', 'events-manager'), 'dbem_events_form_result_success_da', __( 'Customize the message your Danish user sees when they submitted their event.', 'events-manager').$events_placeholder_tip );
				em_options_textarea ( __( 'Success Message (English)', 'events-manager'), 'dbem_events_form_result_success_en', __( 'Customize the message your English user sees when they submitted their event.', 'events-manager').$events_placeholder_tip );
				em_options_textarea ( __( 'Successfully Updated Message (Danish)', 'events-manager'), 'dbem_events_form_result_success_updated_da', __( 'Customize the message your Danish user sees when they resubmit/update their event.', 'events-manager').$events_placeholder_tip );
				em_options_textarea ( __( 'Successfully Updated Message (English)', 'events-manager'), 'dbem_events_form_result_success_updated_en', __( 'Customize the message your English user sees when they resubmit/update their event.', 'events-manager').$events_placeholder_tip );
				em_options_textarea ( __( 'Success Message vicevært (Danish)', 'events-manager'), 'dbem_events_form_result_success_vicevært_da', __( 'Customize the message your Danish vicevært sees when they submitted their event.', 'events-manager').$events_placeholder_tip );
				...
				em_options_textarea ( __( 'Successfully Updated Message vicevært (English)', 'events-manager'), 'dbem_events_form_result_success_updated_vicevært_en', __( 'Customize the message your English vicevært when they resubmit/update their event.', 'events-manager').$events_placeholder_tip );
			?>
