...
<div class="em-menu-pages em-menu-group"  <?php if( !defined('EM_SETTINGS_TABS') || !EM_SETTINGS_TABS) : ?>style="display:none;"<?php endif; ?>>			
		...
		<div class="inside">
			...
			<tr>
				<th><?php echo sprintf(__( '%s page (Danish)', 'events-manager'),__('My bookings','events-manager')); ?>
				</th>
				<td>
					...
					<br />
					<em><?php echo sprintf(__('Danish users can view their bookings for other events on this page.','events-manager'),'<code>[my_bookings]</code>',__('bookings','events-manager')); ?></em>
				</td>
			</tr>	
			<tr>
			...
			<tr>
				<th><?php echo sprintf(__( '%s page (Danish)', 'events-manager'),__('Edit events','events-manager')); ?></th>
				<td>
					...
					<br />
					<em><?php echo sprintf(__('Danish users can view, add and edit their %s on this page.','events-manager'),__('events','events-manager')); ?></em>
				</td>
			</tr>
			<tr>
