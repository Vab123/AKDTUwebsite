 ...
 */
$notice_full = get_option('dbem_booking_button_msg_full_' . pll_current_language());
...
$button_cancel = get_option('dbem_booking_button_msg_cancel_' . pll_current_language());
