...
?>
				<div class="notice notice-warning is-dismissible"><?php echo $warning; ?></div>
			<?php
	...
	?>
		<div class='updated'>
			<p><?php echo sprintf(__('This %s was submitted by a guest. You will find their details in the <em>Anonymous Submitter Info</em> box', 'events-manager'), __('event', 'events-manager')); ?></p>
		</div>
