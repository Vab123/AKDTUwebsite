...
function AKDTU_save_lejeradgang_mail_settings() {
	...
	update_option('AKDTU_FJERNLEJERADGANG_REPLYTO', stripcslashes($_REQUEST['AKDTU_FJERNLEJERADGANG_REPLYTO']));
	update_option('AKDTU_FJERNLEJERADGANG_SUBJECT', stripcslashes($_REQUEST['AKDTU_FJERNLEJERADGANG_SUBJECT']));
	update_option('AKDTU_FJERNLEJERADGANG_MAILCONTENT', stripcslashes($_REQUEST['AKDTU_FJERNLEJERADGANG_MAILCONTENT']));
	update_option('AKDTU_FJERNLEJERADGANG_FORMAT_RENTALS', stripcslashes($_REQUEST['AKDTU_FJERNLEJERADGANG_FORMAT_RENTALS']));
	update_option('AKDTU_FJERNLEJERADGANG_FORMAT_PREVIOUS_GARDENDAYS', stripcslashes($_REQUEST['AKDTU_FJERNLEJERADGANG_FORMAT_PREVIOUS_GARDENDAYS']));
