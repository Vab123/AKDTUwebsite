...
function AKDTU_save_leje_af_fælleshus_beboer_mail_settings() {
	# Save form info
	update_option('dbem_event_approved_email_subject_da', stripcslashes($_REQUEST['dbem_event_approved_email_subject_da']));
	update_option('dbem_event_approved_email_subject_en', stripcslashes($_REQUEST['dbem_event_approved_email_subject_en']));
	update_option('dbem_event_approved_email_body_da', stripcslashes($_REQUEST['dbem_event_approved_email_body_da']));
	update_option('dbem_event_approved_email_body_en', stripcslashes($_REQUEST['dbem_event_approved_email_body_en']));
	update_option('dbem_event_approved_email_attachments_da', stripcslashes($_REQUEST['dbem_event_approved_email_attachments_da']));
	update_option('dbem_event_approved_email_attachments_en', stripcslashes($_REQUEST['dbem_event_approved_email_attachments_en']));

	update_option('dbem_event_reapproved_email_subject_da', stripcslashes($_REQUEST['dbem_event_reapproved_email_subject_da']));
	update_option('dbem_event_reapproved_email_subject_en', stripcslashes($_REQUEST['dbem_event_reapproved_email_subject_en']));
	update_option('dbem_event_reapproved_email_body_da', stripcslashes($_REQUEST['dbem_event_reapproved_email_body_da']));
	update_option('dbem_event_reapproved_email_body_en', stripcslashes($_REQUEST['dbem_event_reapproved_email_body_en']));
