...
function AKDTU_save_ny_bruger_mail_settings() {
	update_option('AKDTU_NYBRUGER_BESTYRELSE_TO', $_REQUEST['AKDTU_NYBRUGER_BESTYRELSE_TO']);
	update_option('AKDTU_NYBRUGER_BESTYRELSE_FROM', $_REQUEST['AKDTU_NYBRUGER_BESTYRELSE_FROM']);
	update_option('AKDTU_NYBRUGER_BESTYRELSE_CC', $_REQUEST['AKDTU_NYBRUGER_BESTYRELSE_CC']);
	update_option('AKDTU_NYBRUGER_BESTYRELSE_REPLYTO', $_REQUEST['AKDTU_NYBRUGER_BESTYRELSE_REPLYTO']);
	update_option('AKDTU_NYBRUGER_BESTYRELSE_SUBJECT', $_REQUEST['AKDTU_NYBRUGER_BESTYRELSE_SUBJECT']);
	update_option('AKDTU_NYBRUGER_BESTYRELSE_MAILCONTENT', $_REQUEST['AKDTU_NYBRUGER_BESTYRELSE_MAILCONTENT']);
	update_option('AKDTU_NYBRUGER_BESTYRELSE_ATTACHMENTS', $_REQUEST['AKDTU_NYBRUGER_BESTYRELSE_ATTACHMENTS']);

	update_option('AKDTU_NYBRUGER_BRUGER_TOGGLE', $_REQUEST['AKDTU_NYBRUGER_BRUGER_TOGGLE']);

	update_option('AKDTU_NYBRUGER_BRUGER_DA_FROM', $_REQUEST['AKDTU_NYBRUGER_BRUGER_FROM']);
	update_option('AKDTU_NYBRUGER_BRUGER_DA_CC', $_REQUEST['AKDTU_NYBRUGER_BRUGER_CC']);
	update_option('AKDTU_NYBRUGER_BRUGER_DA_REPLYTO', $_REQUEST['AKDTU_NYBRUGER_BRUGER_REPLYTO']);
	update_option('AKDTU_NYBRUGER_BRUGER_DA_SUBJECT', $_REQUEST['AKDTU_NYBRUGER_BRUGER_DA_SUBJECT']);
	update_option('AKDTU_NYBRUGER_BRUGER_DA_MAILCONTENT', $_REQUEST['AKDTU_NYBRUGER_BRUGER_DA_MAILCONTENT']);
	update_option('AKDTU_NYBRUGER_BRUGER_DA_ATTACHMENTS', $_REQUEST['AKDTU_NYBRUGER_BRUGER_DA_ATTACHMENTS']);

	update_option('AKDTU_NYBRUGER_BRUGER_EN_FROM', $_REQUEST['AKDTU_NYBRUGER_BRUGER_FROM']);
	update_option('AKDTU_NYBRUGER_BRUGER_EN_CC', $_REQUEST['AKDTU_NYBRUGER_BRUGER_CC']);
	update_option('AKDTU_NYBRUGER_BRUGER_EN_REPLYTO', $_REQUEST['AKDTU_NYBRUGER_BRUGER_REPLYTO']);
	update_option('AKDTU_NYBRUGER_BRUGER_EN_SUBJECT', $_REQUEST['AKDTU_NYBRUGER_BRUGER_EN_SUBJECT']);
	update_option('AKDTU_NYBRUGER_BRUGER_EN_MAILCONTENT', $_REQUEST['AKDTU_NYBRUGER_BRUGER_EN_MAILCONTENT']);
	update_option('AKDTU_NYBRUGER_BRUGER_EN_ATTACHMENTS', $_REQUEST['AKDTU_NYBRUGER_BRUGER_EN_ATTACHMENTS']);
