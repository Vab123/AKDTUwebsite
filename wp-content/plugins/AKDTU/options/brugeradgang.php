...
function AKDTU_save_brugeradgang_mail_settings() {
	update_option('AKDTU_FJERNBRUGERADGANG_TO', $_REQUEST['AKDTU_FJERNBRUGERADGANG_TO']);
	update_option('AKDTU_FJERNBRUGERADGANG_FROM', $_REQUEST['AKDTU_FJERNBRUGERADGANG_FROM']);
	update_option('AKDTU_FJERNBRUGERADGANG_CC', $_REQUEST['AKDTU_FJERNBRUGERADGANG_CC']);
	update_option('AKDTU_FJERNBRUGERADGANG_REPLYTO', $_REQUEST['AKDTU_FJERNBRUGERADGANG_REPLYTO']);
	update_option('AKDTU_FJERNBRUGERADGANG_SUBJECT', $_REQUEST['AKDTU_FJERNBRUGERADGANG_SUBJECT']);
	update_option('AKDTU_FJERNBRUGERADGANG_MAILCONTENT', $_REQUEST['AKDTU_FJERNBRUGERADGANG_MAILCONTENT']);
	update_option('AKDTU_FJERNBRUGERADGANG_FORMAT_RENTALS', $_REQUEST['AKDTU_FJERNBRUGERADGANG_FORMAT_RENTALS']);
	update_option('AKDTU_FJERNBRUGERADGANG_FORMAT_PREVIOUS_GARDENDAYS', $_REQUEST['AKDTU_FJERNBRUGERADGANG_FORMAT_PREVIOUS_GARDENDAYS']);
	update_option('AKDTU_FJERNBRUGERADGANG_FORMAT_FUTURE_GARDENDAYS', $_REQUEST['AKDTU_FJERNBRUGERADGANG_FORMAT_FUTURE_GARDENDAYS']);
	update_option('AKDTU_FJERNBRUGERADGANG_ATTACHMENTS', $_REQUEST['AKDTU_FJERNBRUGERADGANG_ATTACHMENTS']);
