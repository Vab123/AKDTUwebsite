 ...
 * 
 * @param array[string,string] $args Arguments for the created garden days. Keys must include 'title', 'post_content', 'lang', 'date', 'rsvp->rsvp', 'rsvp->date', 'rsvp->time', 'rsvp->spaces', 'rsvp->max_spaces', 'event_lang', 'publish_date', 'start_time', 'end_time'. Can be prepared using a call to opret_havedage()
 * 
