...
if (isset($_REQUEST['action'])) {
	if ($_REQUEST['action'] == 'delete_user_signup' && isset($_REQUEST['user']) && isset($_REQUEST['email']) && isset($_REQUEST['takeover_time'])) {
		delete_user_signup($_REQUEST['user'], $_REQUEST['email'], $_REQUEST['takeover_time']);
	}
}
 ...
 */
function delete_user_signup($apartment_number, $email, $takeover_time){
	# Check if deletion was successful
	if (delete_user_creation_permit($apartment_number, $email, $takeover_time)) {
