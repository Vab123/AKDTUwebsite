...
class SwpmSettings {
	...
	private function tab_1() {
		...
		add_settings_field(
			'login-page-url',
			SwpmUtils::_( 'Login Page URL (Danish)' ),
		...
		add_settings_field(
			'profile-page-url',
			SwpmUtils::_( 'Edit Profile Page URL (Danish)' ),
			array( &$this, 'textfield_long_callback' ),
			'simple_wp_membership_settings',
			'pages-settings',
			array(
		...
		add_settings_field(
			'reset-page-url',
			SwpmUtils::_( 'Password Reset Page URL (Danish)' ),
			array( &$this, 'textfield_long_callback' ),
			'simple_wp_membership_settings',
			'pages-settings',
			array(
	...
	public function sanitize_tab_1( $input ) {
		...
		$output['login-page-url-english']   = esc_url( $input['login-page-url-english'] );
		$output['registration-page-url']    = esc_url( $input['registration-page-url'] );
		$output['profile-page-url']         = esc_url( $input['profile-page-url'] );
		$output['profile-page-url-english'] = esc_url( $input['profile-page-url-english'] );
		$output['reset-page-url']           = esc_url( $input['reset-page-url'] );
		$output['reset-page-url-english']   = esc_url( $input['reset-page-url-english'] );
