    ...
    <form id="swpm-editprofile-form" name="swpm-editprofile-form" method="post" action="" class="swpm-validate-form">
        ...
        <table>
            ...
            <tr class="swpm-profile-username-row" <?php apply_filters('swpm_edit_profile_form_username_tr_attributes', ''); ?>>
                <td><label for="user_name"><?php pll_e('Username','simple-membership'); ?></label></td>
                <td><?php echo $user_name ?></td>
            </tr>
            <tr class="swpm-profile-email-row">
                <td><label for="email"><?php pll_e('Email','simple-membership'); ?></label></td>
            ...
            <tr class="swpm-profile-password-row">
                <td><label for="password"><?php pll_e('Password','simple-membership'); ?></label></td>
                <td><input type="password" id="password" value="" size="50" name="password" class="<?php echo $pass_class;?>" autocomplete="off" placeholder="<?php pll_e('Leave empty to keep the current password','simple-membership'); ?>" /></td>
            </tr>
            <tr class="swpm-profile-password-retype-row">
                <td><label for="password_re"><?php pll_e('Repeat Password','simple-membership'); ?></label></td>
                <td><input type="password" id="password_re" value="" size="50" name="password_re" autocomplete="off" placeholder="<?php pll_e('Leave empty to keep the current password','simple-membership'); ?>" /></td>
            </tr>
            <tr class="swpm-profile-firstname-row" <?php apply_filters('swpm_edit_profile_form_firstname_tr_attributes', ''); ?>>
                <td><label for="first_name"><?php echo pll_e('First Name','simple-membership'); ?></label></td>
            ...
            <tr class="swpm-profile-lastname-row" <?php apply_filters('swpm_edit_profile_form_lastname_tr_attributes', ''); ?>>
                <td><label for="last_name"><?php pll_e('Last Name','simple-membership'); ?></label></td>
