...
Tags: dark, dark mode, night mode, dark theme, accessibility, dark mode plugin, social share, Gutenberg block, toggle, social sharing, dark mode toggle
...
8. **Remember Dark Mode** – Enable the plugin to remember users' choice and automatically enable dark mode for visitors who used it before.
...
4. **Prmeium Dark Mode Color Presets** – 13 exclusive ready-made dark mode color presets are available to quickly change the dark mode color from the predefined presets.
